...
@pytest.mark.parametrize("collections, modalities, rules, download, result", [
    ...
    # Test Download
    (["4D-Lung"], "CT", {"CT": "SeriesInstanceUID == 1.3.6.1.4.1.14519.5.2.1.6834.5010.545135956948851752674310887985"}, True, ["1.3.6.1.4.1.14519.5.2.1.6834.5010.545135956948851752674310887985"])
